...
export function Navbar() {
  return (
    <header className="sticky top-0 z-50 w-full">
      <nav className="glass-strong mx-auto max-w-7xl mt-4 mx-4 sm:mx-6 lg:mx-auto rounded-2xl px-6 py-3 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 group">
          <span className="text-xl font-bold gradient-text-subtle">✈️ glyde</span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="/comparison" className="flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div className="flex items-center gap-3">
          <a
            href="https://github.com/yashgkar/glyde"
            target="_blank"
